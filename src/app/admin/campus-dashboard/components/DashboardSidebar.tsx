      ...
      >
        ...
        >
          <div className={`flex items-center gap-2 ${isCollapsed ? 'lg:hidden' : ''}`}>
            <img src="/campus-one-logo.png" alt="Logo" className="w-7 h-7 object-contain rounded-lg" />
          ...
          <div className={`${isCollapsed ? 'lg:flex hidden' : 'hidden'} items-center justify-center`}>
            <img src="/campus-one-logo.png" alt="Logo" className="w-8 h-8 object-contain rounded-lg" />
          </div>
