  ...
  return (
    <section className="dashboard-screen">
      <header className="dashboard-hero">
        <div>
          <h2>APICENTER Super Admin</h2>
          <p>System administration, tenant management, and service health monitoring across the platform.</p>
        </div>
      </header>
      ...
      {/* Tab Navigation */}
      <div style={{ position: 'fixed', bottom: '28px', left: '320px', right: '28px', display: 'flex', gap: '12px', justifyContent: 'center', zIndex: 30 }}>
        <button
          onClick={() => setActiveTab('dashboard')}
          className={activeTab === 'dashboard' ? 'primary-btn' : 'ghost-btn'}
        ...
        <button
          ...
          className={activeTab === 'services' ? 'primary-btn' : 'ghost-btn'}
          style={{ padding: '10px 20px', fontSize: '0.9rem' }}
        >
          Services
        </button>
        <button
          ...
          className={activeTab === 'users' ? 'primary-btn' : 'ghost-btn'}
          style={{ padding: '10px 20px', fontSize: '0.9rem' }}
        >
          Admin Users
        </button>
        <button
          ...
          className={activeTab === 'tenants' ? 'primary-btn' : 'ghost-btn'}
          style={{ padding: '10px 20px', fontSize: '0.9rem' }}
        >
          Tenants
        </button>
